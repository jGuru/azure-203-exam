...
An overview of the availability features of Azure virtual machines (VMs).
...
![Availability zones](./media/three-zones-per-region.png)
...
![Managed availability set](./media/md-fd-updated.png)


VMs within an availability set are also automatically distributed across update domains. 

![Availability sets](./media/ud-fd-configuration.png)
